...
- **GDatepicker**: bấm **tiêu đề** panel để **chọn nhanh tháng & năm** — leo cấp ngày → lưới 12 tháng →
  lưới 12 năm (prev/next lật theo cấp: tháng / năm / trang 12 năm), khỏi phải next từng tháng. Chọn ô
  tháng/năm hạ cấp lại; tôn trọng `min`/`max`.
