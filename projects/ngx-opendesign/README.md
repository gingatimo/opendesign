...
Nút (Button, Icon Button) · Form (Input, Textarea, Checkbox, Toggle, Radio, Select) · Hiển thị (Badge, Spinner, Progress, Chip, Avatar, Card, Icon) · Overlay (Dialog, Tooltip, Toast) · Điều hướng (Tabs, Topbar, Sidebar, Link).
