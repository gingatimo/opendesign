...
qua contenteditable; toolbar undo/redo, kiểu khối p|h1-h3|blockquote, đậm/nghiêng/gạch, danh sách,
căn lề, chèn/bỏ liên kết, xoá định dạng; `pasteMode` text|html; giá trị ngoài + HTML dán tự sanitize,
